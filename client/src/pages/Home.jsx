        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12 text-black">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              Find wines by name, region, or flavor profile with our advanced
              search engine.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              Get comprehensive details about each wine, including origin,
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[1, 2, 3, 4].map((i) => {
              ...
              return (
                ...
                >
                  <img
                    src={`https://images.unsplash.com/photo-${imageSrc}?w`}
                    alt="Wine"
